...
CREATE TABLE `LOG_CLIENTE` (
  `LogClienteID` int NOT NULL AUTO_INCREMENT,
...
INSERT INTO `LOG_CLIENTE` VALUES (1,'Campo anterior: Tuckie - Campo nuevo: Tomás',50,'UPDATE','Cliente','root@localhost','2023-11-17');
